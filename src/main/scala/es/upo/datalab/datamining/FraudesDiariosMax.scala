...
import es.upo.datalab.datamining.MappingPendientes
...
object FraudesDiariosMax {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println("Leyendo dataset T123")

//    val df = LoadTableParquet.loadTable("hdfs://10.141.0.224:9000/fabregas/endesa/datasets_parquet/dataset_fraude_diario_completo/")
//    val df2 = LoadTableParquet.loadTable("hdfs://10.141.0.224:9000/fabregas/endesa/datasets_parquet/dataset_no_fraude_diario_completo/")


    val df = LoadTableParquet.loadTable("/Users/davgutavi/Desktop/modelos_variables_endesa/dataset_t123_d")

    val rdd: RDD[Row] = df.rdd.map(r => MappingPendientes.call(r))
    //    println(rdd.count())

//    val rdd2: RDD[Row] = df2.rdd.map(r => MappingPendientes.call(r))
    ...
    val schema = Array(
      ...
      ,StructField("d261", DoubleType, nullable = true)
...
//    val newdf2: DataFrame = sqlContext.createDataFrame(rdd2, customSchema)

    newdf.show(20)
//    newdf2.show(20)

    newdf.write.option("header", "true").save("/Users/davgutavi/Desktop/modelos_variables_endesa/dataset_t123_d/dataset_t123_d_pendientes")

//    newdf2.write.option("header", "true").save("hdfs://10.141.0.224:9000/fabregas/endesa/datasets_parquet/apendientes_02")
