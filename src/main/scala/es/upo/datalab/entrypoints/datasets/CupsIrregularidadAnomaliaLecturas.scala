...
//
//      maestroContratosExpedientesMaestroAparatos.coalesce(1).write.option("header","true").save(TabPaths.prefix_05+"MaestroContratosExpedientesMaestroAparatos_fechas_endesa")
//                  println("maestroContratosExpedientesMaestroAparatos almacenado en parquet")
//      maestroContratosExpedientesMaestroAparatos.coalesce(1).write.option("header","true").csv(TabPaths.prefix_06+"MaestroContratosExpedientesMaestroAparatos_fechas_endesa")
...
//      maestroContratosExpedientesMaestroAparatosCurvasCarga.coalesce(1).write.option("header","true").save(TabPaths.prefix_05+"MaestroContratosExpedientesMaestroAparatosCurvasCarga_fechas_logico")
//      println("maestroContratosExpedientesMaestroAparatosCurvasCargas almacenado en parquet")
//      maestroContratosExpedientesMaestroAparatosCurvasCarga.coalesce(1).write.option("header","true").csv(TabPaths.prefix_06+"MaestroContratosExpedientesMaestroAparatosCurvasCarga_fechas_logico")
...
//           maestroContratosExpedientesMaestroAparatosCurvasCarga.where("anomalia='S'AND (flectreg BETWEEN add_months(fapexpd,-6) AND fapexpd) AND (flectreg BETWEEN fpsercon AND ffinvesu)")
      ...
      datasetLecturasIrregularidad.coalesce(1).write.option("header","true").save(TabPaths.prefix_03+"lecturasIrregularidad_10")
      println("Parquet Irregularidad Guardada")
      datasetLecturasIrregularidad.coalesce(1).write.option("header","true").csv(TabPaths.prefix_04+"lecturasIrregularidad_10")
      ...
      datasetLecturasAnomalia.coalesce(1).write.option("header","true").save(TabPaths.prefix_03+"lecturasAnomalia_10")
      println("Parquet Anomalía Guardada")
      datasetLecturasAnomalia.coalesce(1).write.option("header","true").csv(TabPaths.prefix_04+"lecturasAnomalia_10")
